...
main(void)
{
    ...
    if (rx_pn_runtime_add_net(&pn_runtime, &auto_a, PERIOD_US, 0) != 0 ||
        rx_pn_runtime_add_net(&pn_runtime, &auto_b, PERIOD_US, 0) != 0 ||
        rx_pn_runtime_add_net(&pn_runtime, &auto_c, PERIOD_US, 0) != 0) {
