"""PN 04-mix — three different Petri nets in one runtime.

A: simple toggle (light_pn), B: blinking (blink_pn), C: auto-off (auto_pn).
...
def main() -> None:
    ...
    pn_rt = PnRuntime()
    pn_rt.add_net(light_a)
    pn_rt.add_net(blink_b)
    pn_rt.add_net(auto_c)
